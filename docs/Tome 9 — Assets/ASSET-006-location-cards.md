...
# ASSET-006 — Cartes de localisation

## Autorité

Une carte de localisation assemble une identité, une provenance et un asset validé. L’absence est explicite et n’est jamais remplacée silencieusement.
...
`PokemonGo-API-/scripts/import/location-cards.js`, `src/components/admin/pokemon`.
