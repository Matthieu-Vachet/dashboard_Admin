...
# ASSET-005 — Backgrounds

## Autorité

Les backgrounds métier sont des données canoniques exposées par le provider ; les fonds purement décoratifs relèvent des tokens et pseudo-éléments du Design System.
...
`src/components/admin/pokemon/backgrounds-panel.jsx`, `PokemonGo-API-/src/routes/backgrounds.js`.
