---
id: ASSET-002
title: Assets de la page d’accueil
version: 1.0.0
status: Active
...
# ASSET-002 — Assets de la page d’accueil

## Autorité

Les illustrations de la Home Admin utilisent le registre UI partagé, les tokens du Design System et un fallback visible. Aucune URL distante n’est concaténée dans une carte.
...
`src/components/admin/pokemon/admin-command-center.tsx`, `src/data/ui-assets.json`.
