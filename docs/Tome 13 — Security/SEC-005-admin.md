...
# SEC-005 — Administration

## Autorité

Les actions sensibles sont explicites, auditables et protégées contre les doubles clics. Les suppressions logiques exigent un motif et conservent l’historique.
...
`src/lib/admin-pokemon-global-regeneration.ts`, `PokemonGo-API-/src/services/pokemon-identity-service.js`.
