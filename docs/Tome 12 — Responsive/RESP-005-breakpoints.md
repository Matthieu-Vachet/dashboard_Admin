...
# RESP-005 — Breakpoints

## Autorité

Les breakpoints suivent Tailwind ; la validation couvre 320, 360, 375, 390, 414/430, 768, 1024 et 1440 px dans les deux thèmes.
...
`src/app/globals.css`, `scripts/test-pokemon-responsive.mjs`.
