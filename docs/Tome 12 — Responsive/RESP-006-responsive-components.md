...
# RESP-006 — Composants responsive

## Autorité

Modal, picker, sidebar, cartes statistiques et barres de filtres portent le comportement responsive partagé. Les composants métier ne dupliquent pas ces règles.
...
`src/components/ui/modal.tsx`, `src/components/admin/pokemon/pvp-battle-lab.tsx`.
