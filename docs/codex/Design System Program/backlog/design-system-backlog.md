...
| DS-BACKLOG-013 | Qualité transverse | Accessibility | Prochain sprint recommandé : noms de formulaires, descriptions et erreurs | planned | P0 | élevé | L | Sprint Field validé |
