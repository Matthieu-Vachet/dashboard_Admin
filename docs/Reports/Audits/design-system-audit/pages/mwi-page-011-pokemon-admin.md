# MWI-PAGE-011 — /pokemon-admin

- Source: `src/app/(dashboard)/pokemon-admin/page.tsx`.
- Root definitions: [PokemonAdminPage](../components/app-dashboard-pokemon-admin-page-pokemonadminpage.md).
- Layout coverage: MWI-LAYOUT-001, MWI-LAYOUT-002.
