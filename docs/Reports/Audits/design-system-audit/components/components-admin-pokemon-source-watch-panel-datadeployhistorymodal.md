---
id: MWI-COMP-231
component: "DataDeployHistoryModal"
...
- Component ID: `MWI-COMP-231`.
- Location: `Dashboard Admin/src/components/admin/pokemon/source-watch-panel.tsx`:216.
- File range: lines 216–357.
...
| MWI-COMP-312 | [DataDeployHistoryModal](../components/components-pokemon-admin-source-watch-panel-datadeployhistorymodal.md) (MWI-COMP-312) | Renders/imports this component |
  ...
  - <section>
    - <header>
      - <div>
        ...
        - <p>
          - <span>
      - <button aria-label="Fermer l'historique data">
    - <div>
      - <div>
        - <article>
          - <div>
...
Unique HTML/React tags: `a`, `article`, `button`, `div`, `ExternalLink`, `h3`, `header`, `p`, `section`, `small`, `span`, `strong`.
...
- Boolean properties for Figma: Hover, Warning, Success, Empty, Collapsed, Expanded, Scrollable.
...
- Alignment utilities: `items-center, items-start, justify-between, md:items-start, md:justify-between, place-items-center, sm:items-center, sm:justify-between`.
...
| Spacing | `gap-1`, `gap-2`, `gap-3`, `gap-4`, `inset-0`, `mr-2`, `mt-1`, `mt-2`, `mt-3`, `mt-4`, `p-3`, `p-4`, `p-5`, `px-2.5`, `px-3`, `py-1`, `py-1.5`, `sm:p-5` |
...
| Typography | `break-all`, `break-words`, `font-black`, `font-bold`, `font-mono`, `hover:text-white`, `leading-6`, `md:text-right`, `text-[10px]`, `text-[11px]`, `text-2xl`, `text-amber-100`, `text-cyan-100`, `text-cyan-200/75`, `text-emerald-100`, `text-left`, `text-lg`, `text-slate-300`, `text-slate-400`, `text-sm`, `text-white`, `text-xl`, `text-xs`, `tracking-[0.12em]`, `tracking-[0.14em]`, `tracking-[0.22em]`, `uppercase` |
| Radius | `rounded-2xl`, `rounded-3xl`, `rounded-full` |
| Borders/strokes | `border`, `border-amber-300/20`, `border-b`, `border-cyan-200/20`, `border-cyan-300/20`, `border-dashed`, `border-emerald-300/20`, `border-white/10`, `border-white/15` |
| Shadows/elevation | `shadow-[0_24px_120px_rgba(0,0,0,.5)]` |
| Opacity | Not found |
| Background | `backdrop-blur-xl`, `bg-amber-400/10`, `bg-cyan-300/10`, `bg-cyan-400/10`, `bg-emerald-400/10`, `bg-slate-950`, `bg-slate-950/35`, `bg-slate-950/82`, `bg-white/[0.04]`, `bg-white/[0.045]`, `bg-white/[0.055]`, `bg-white/[0.06]`, `hover:bg-white/10` |
| Animation | Not found |
...
- `break-all text-sm font-black text-white`
...
- `flex min-w-0 flex-col gap-2 rounded-2xl border border-white/10 bg-slate-950/35 p-3 sm:flex-row sm:items-center sm:justify-between`
...
- `inline-flex rounded-full border border-emerald-300/20 bg-emerald-400/10 px-3 py-1.5 font-mono text-xs font-black text-emerald-100`
- `max-h-[calc(100dvh-14rem)] overflow-y-auto p-5`
- `min-w-0`
- `mr-2 inline-flex rounded-full border border-cyan-200/20 bg-cyan-300/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.12em] text-cyan-100`
...
- `mt-4 grid gap-2`
- `mt-4 grid gap-3 text-xs font-bold text-slate-300 sm:grid-cols-3`
...
- `rounded-2xl border border-amber-300/20 bg-amber-400/10 p-3 text-xs font-bold text-amber-100`
- `rounded-2xl border border-dashed border-white/15 p-5 text-sm font-bold text-slate-400`
- `rounded-2xl border border-white/10 bg-slate-950/35 p-3`
...
- `shrink-0 rounded-full border border-white/10 bg-white/[0.055] px-3 py-1 text-xs font-black text-slate-300`
...
- Responsive utilities: `md:flex-row`, `md:items-start`, `md:justify-between`, `md:text-right`, `sm:flex-row`, `sm:grid-cols-3`, `sm:items-center`, `sm:justify-between`, `sm:max-h-[calc(100dvh-3rem)]`, `sm:p-5`.
...
- ARIA attributes: `aria-label="Fermer l'historique data"`, `aria-modal="true"`.
- Roles: `role="dialog"`.
...
- Boolean properties: Hover, Warning, Success, Empty, Collapsed, Expanded, Scrollable.
- Instance swaps: `ExternalLink`.
