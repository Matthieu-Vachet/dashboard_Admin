...
- Component ID: `MWI-COMP-197`.
- Location: `Dashboard Admin/src/components/admin/pokemon/pokemon-card.jsx`:61.
- File range: lines 61–68.
...
| Typography | `font-black`, `text-slate-200`, `text-xs` |
| Radius | `rounded-lg` |
...
- `inline-flex min-h-8 items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/10 px-3 text-xs font-black text-slate-200`
- `truncate`
