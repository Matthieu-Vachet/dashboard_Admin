...
category: "Page"
status: exported
source: "src/app/(dashboard)/pomodoro/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /pomodoro. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-014`.
- Location: `Dashboard Admin/src/app/(dashboard)/pomodoro/page.tsx`:3.
...
|---|---|---|
| @/components/admin/dashboard/pomodoro | Pomodoro | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-041 | [Pomodoro](../components/components-admin-dashboard-pomodoro-pomodoro.md) (MWI-COMP-041) | JSX/import relation |
...
Unique HTML/React tags: `Pomodoro`.
