...
- Component ID: `MWI-COMP-111`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:351.
- File range: lines 351–353.
...
Unique HTML/React tags: `Badge`, `div`, `span`.
...
```tsx
{ label, items, empty }: { label: string; items: string[]; empty?: string }
```
...
- Boolean properties for Figma: Error, Warning, Success, Empty.
- Text properties: `empty`, `items`, `label`.
...
| Spacing | `gap-2`, `mr-1`, `mt-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-semibold`, `text-amber-100`, `text-cyan-100`, `text-emerald-100`, `text-muted`, `text-rose-100`, `text-violet-100`, `text-xs`, `tracking-[0.12em]`, `uppercase` |
| Radius | Not found |
| Borders/strokes | `border-brand-2/30`, `border-brand-3/30`, `border-brand/30`, `border-danger/35`, `border-line`, `border-warning/35` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-brand-2/10`, `bg-brand-3/10`, `bg-brand/12`, `bg-danger/12`, `bg-warning/12`, `bg-white/[0.06]` |
| Animation | Not found |
...
- `mr-1 text-xs font-black uppercase tracking-[0.12em] text-muted`
...
- Boolean properties: Error, Warning, Success, Empty.
- Instance swaps: Not found.
