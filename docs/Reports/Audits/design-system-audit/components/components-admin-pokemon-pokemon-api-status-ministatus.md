...
Pokémon internal component implemented in src/components/admin/pokemon/pokemon-api-status.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-194`.
- Location: `Dashboard Admin/src/components/admin/pokemon/pokemon-api-status.tsx`:113.
- File range: lines 113–134.
...
Unresolved/external JSX tags: `ArrowUpRight`.
...
Unique HTML/React tags: `ArrowUpRight`, `div`, `span`.
...
| Spacing | `gap-1`, `gap-2`, `gap-3`, `px-3`, `py-2` |
| Sizing | Not found |
| Typography | `font-black`, `text-brand-2`, `text-foreground`, `text-muted`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
...
- `flex items-center justify-between gap-3 rounded-lg border border-line bg-black/15 px-3 py-2`
- `inline-flex items-center gap-1 text-xs font-black text-foreground`
- `inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.16em] text-muted`
- `text-brand-2`
