...
Form internal component implemented in src/components/admin/forms/javascript-exercises.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-080`.
- Location: `Dashboard Admin/src/components/admin/forms/javascript-exercises.tsx`:190.
- File range: lines 190–220.
...
Unique HTML/React tags: `Card`, `div`, `Icon`, `span`, `strong`.
...
| Sizing | `h-11`, `w-11` |
| Typography | `font-black`, `text-3xl`, `text-brand`, `text-brand-2`, `text-brand-3`, `text-muted`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
| Borders/strokes | `border`, `border-brand-2/25`, `border-brand-3/25`, `border-brand/25` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-brand-2/10`, `bg-brand-3/10`, `bg-brand/10` |
| Animation | Not found |
