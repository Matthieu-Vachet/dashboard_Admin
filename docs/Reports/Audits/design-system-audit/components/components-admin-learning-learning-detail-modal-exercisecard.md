...
- Component ID: `MWI-COMP-100`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:136.
- File range: lines 136–149.
...
| @/types/admin/learning | LearningProgressMutationResult, LearningProgressPatch, RuntimeLearningExercise | internal |
...
Unique HTML/React tags: `CardHeader`, `CheckCircle2`, `details`, `div`, `MetaBlock`, `p`, `ProgressButton`, `summary`, `TagRow`, `UnitCard`, `Validation`.
...
```tsx
{ item, saving, onSetProgress }: { item: RuntimeLearningExercise; saving: boolean; onSetProgress: (id: string, patch: LearningProgressPatch) => Promise<LearningProgressMutationResult | null> }
```

Exact local props contract when statically resolvable:

```tsx
{ item: RuntimeLearningExercise; saving: boolean; onSetProgress: (id: string, patch: LearningProgressPatch) => Promise<LearningProgressMutationResult | null> }
```
...
- Boolean properties for Figma: Hover, Error, Warning, Success, Empty.
...
| Spacing | `mt-2`, `mt-3`, `mt-4`, `p-0`, `p-3`, `px-3`, `px-4`, `px-5` |
| Sizing | `h-10`, `min-h-10`, `min-h-12`, `min-h-9`, `w-10` |
| Typography | `font-black`, `font-semibold`, `hover:text-foreground`, `leading-6`, `text-amber-100`, `text-brand`, `text-brand-2`, `text-brand-3`, `text-cyan-100`, `text-danger`, `text-emerald-100`, `text-foreground`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-warning`, `text-white`, `text-xs` |
| Radius | `rounded-lg` |
| Borders/strokes | `border`, `border-brand-2/30`, `border-brand-3/25`, `border-brand-3/30`, `border-brand/30`, `border-danger/30`, `border-danger/35`, `border-line`, `border-transparent`, `border-warning/20`, `border-warning/30`, `border-warning/35`, `border-white/10`, `hover:border-danger/50`, `hover:border-line-strong` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-brand-2/10`, `bg-brand-3/10`, `bg-brand/10`, `bg-brand/12`, `bg-danger/10`, `bg-danger/12`, `bg-danger/15`, `bg-transparent`, `bg-warning/[0.05]`, `bg-warning/10`, `bg-warning/12`, `bg-white/[0.045]`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
| Animation | Not found |
...
| `bg-warning/[0.05]` | base | static occurrence |
...
- `cursor-pointer text-sm font-black text-warning`
...
- `mt-3 rounded-lg border border-warning/20 bg-warning/[0.05] p-3`
...
- Boolean properties: Hover, Error, Warning, Success, Empty.
- Instance swaps: `CheckCircle2`.
