...
Pokémon feature component implemented in src/components/admin/pokemon/raids-panel.jsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-210`.
- Location: `Dashboard Admin/src/components/admin/pokemon/raids-panel.jsx`:183.
- File range: lines 183–288.
...
|---|---|---|
| lucide-react | Download, Eye, RefreshCcw, RotateCcw, Sparkles | icons |
...
| MWI-COMP-209 | [RaidSection](../components/components-admin-pokemon-raids-panel-raidsection.md) (MWI-COMP-209) | JSX/import relation |

Unresolved/external JSX tags: `Download`, `Eye`, `RefreshCcw`, `RotateCcw`, `Sparkles`.
...
| MWI-COMP-309 | [RaidsPanel](../components/components-pokemon-admin-raids-panel-raidspanel.md) (MWI-COMP-309) | Renders/imports this component |
...
Unique HTML/React tags: `AssetStatCard`, `button`, `DatasetEventBanner`, `DatasetFilterBar`, `DatasetSourceHeader`, `div`, `Download`, `Eye`, `p`, `Panel`, `RaidSection`, `RefreshCcw`, `RotateCcw`, `Sparkles`.

## 5. React structure and state management

- Hooks: `useMemo`, `useState`.
- Local state initializers: `query = ""`, `shinyOnly = false`, `unmatchedOnly = false`.
...
| raids | Not found | See exact signature/contract below |
...
| Typography | `font-black`, `font-bold`, `placeholder:text-slate-500`, `text-amber-100`, `text-amber-100/74`, `text-amber-50`, `text-cyan-100`, `text-cyan-100/72`, `text-cyan-50`, `text-emerald-100`, `text-emerald-100/72`, `text-emerald-50`, `text-red-100/74`, `text-red-50`, `text-sky-100/72`, `text-sky-50`, `text-slate-200`, `text-slate-300`, `text-sm`, `text-violet-100`, `text-violet-100/72`, `text-violet-50`, `text-white` |
| Radius | `rounded-2xl` |
| Borders/strokes | `border`, `border-amber-200/22`, `border-amber-200/25`, `border-amber-200/30`, `border-cyan-200/20`, `border-cyan-200/25`, `border-cyan-200/30`, `border-emerald-200/20`, `border-emerald-200/25`, `border-emerald-200/30`, `border-red-200/22`, `border-red-200/30`, `border-sky-200/20`, `border-sky-200/30`, `border-slate-200/20`, `border-violet-200/22`, `border-violet-200/25`, `border-violet-200/30`, `border-white/10`, `focus:border-cyan-300/60`, `focus:ring-4`, `focus:ring-cyan-400/10`, `hover:border-cyan-200/50`, `outline-none` |
| Shadows/elevation | `shadow-[0_14px_45px_rgba(14,165,233,.26)]`, `shadow-[0_22px_90px_rgba(0,0,0,.24)]` |
| Opacity | Not found |
| Background | `backdrop-blur-xl`, `bg-amber-400/[0.06]`, `bg-amber-400/12`, `bg-amber-400/14`, `bg-cyan-400/[0.055]`, `bg-cyan-400/12`, `bg-cyan-400/14`, `bg-emerald-300/16`, `bg-emerald-400/[0.055]`, `bg-emerald-400/12`, `bg-emerald-400/14`, `bg-gradient-to-r`, `bg-red-400/[0.06]`, `bg-red-400/12`, `bg-red-400/14`, `bg-sky-400/[0.055]`, `bg-sky-400/12`, `bg-sky-400/14`, `bg-slate-300/10`, `bg-slate-950/45`, `bg-violet-300/16`, `bg-violet-400/[0.06]`, `bg-violet-400/12`, `bg-violet-400/14`, `bg-white/[0.055]`, `bg-white/[0.075]`, `from-amber-400/24`, `from-emerald-400/24`, `from-sky-500`, `from-sky-500/24`, `from-violet-500/24`, `hover:bg-cyan-400/15`, `to-cyan-400`, `to-slate-900/20`, `via-cyan-300/12`, `via-fuchsia-300/10`, `via-orange-300/10`, `via-teal-300/10` |
...
| `Ultra-brèches` | base | static occurrence |
