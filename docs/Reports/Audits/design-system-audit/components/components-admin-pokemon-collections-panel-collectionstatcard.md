...
Pokémon internal component implemented in src/components/admin/pokemon/collections-panel.jsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-149`.
- Location: `Dashboard Admin/src/components/admin/pokemon/collections-panel.jsx`:333.
- File range: lines 333–357.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-150 | [CollectionsPanel](../components/components-admin-pokemon-collections-panel-collectionspanel.md) (MWI-COMP-150) | Renders/imports this component |
...
| Sizing | `h-12`, `max-h-full`, `max-w-full`, `min-w-0`, `w-12` |
...
- `grid h-12 w-12 shrink-0 place-items-center rounded-2xl border border-white/10 bg-slate-950/45 p-2 shadow-inner`
