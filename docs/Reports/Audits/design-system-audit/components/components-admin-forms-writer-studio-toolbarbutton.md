...
- Component ID: `MWI-COMP-089`.
- Location: `Dashboard Admin/src/components/admin/forms/writer-studio.tsx`:259.
- File range: lines 259–273.
...
- Text properties: `icon`, `label`, `onClick`.
