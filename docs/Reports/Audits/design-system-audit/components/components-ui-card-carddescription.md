...
- Component ID: `MWI-COMP-322`.
- Location: `Dashboard Admin/src/components/ui/card.tsx`:61.
...
| Spacing | `mt-1` |
| Sizing | Not found |
| Typography | `font-medium`, `leading-6`, `text-muted`, `text-sm` |
| Radius | Not found |
...
- `mt-1 text-sm font-medium leading-6 text-muted`

## 12. Conditional classes, variables and inline styles

### Conditional class expressions

- `cn("mt-1 text-sm font-medium leading-6 text-muted", className)`
