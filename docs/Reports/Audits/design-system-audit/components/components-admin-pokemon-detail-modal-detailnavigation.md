...
- Component ID: `MWI-COMP-171`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:682.
- File range: lines 682–689.
...
Unique HTML/React tags: `div`, `PokemonMiniCard`.
...
```tsx
{ previousEntry, nextEntry, onPrevious, onNext }
```
...
- Text properties: `nextEntry`, `onNext`, `onPrevious`, `previousEntry`.
...
| `grid-cols-1` | base | static occurrence |
