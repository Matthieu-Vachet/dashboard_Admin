...
source: "src/components/pokemon-admin/max-battles-panel.jsx"
lines: 3-3
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for MaxBattlesPanel. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-307`.
- Location: `Dashboard Admin/src/components/pokemon-admin/max-battles-panel.jsx`:3.
- File range: lines 3–3.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-189.
