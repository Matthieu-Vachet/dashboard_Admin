...
- Component ID: `MWI-COMP-132`.
- Location: `Dashboard Admin/src/components/admin/pokemon/admin-ui.jsx`:82.
- File range: lines 82–118.
...
| MWI-COMP-291 | [BarList](../components/components-pokemon-admin-admin-ui-barlist.md) (MWI-COMP-291) | Renders/imports this component |
...
| labelKey | labelKey = "id" | See exact signature/contract below |
| valueKey | valueKey = "count" | See exact signature/contract below |

Exact parameter signature:

```tsx
{ items, labelKey = "id", valueKey = "count" }
```
...
- Text properties: `items`, `labelKey`, `valueKey`.
...
| Spacing | `gap-3`, `mb-2`, `mt-2`, `p-3`, `p-4`, `px-2.5`, `py-1`, `space-y-3` |
| Sizing | `h-2.5`, `h-full`, `min-w-0` |
| Typography | `font-black`, `font-bold`, `font-mono`, `leading-5`, `text-slate-100`, `text-slate-400`, `text-sm`, `text-white`, `text-xs` |
| Radius | `rounded-2xl`, `rounded-full` |
| Borders/strokes | `border`, `border-dashed`, `border-white/10`, `border-white/15` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-gradient-to-r`, `bg-slate-950/35`, `bg-white/10`, `from-cyan-400`, `to-violet-500`, `via-blue-500` |
| Animation | Not found |
...
| `to-violet-500` | base | static occurrence |
| `truncate` | base | static occurrence |
| `via-blue-500` | base | static occurrence |

Exact className combinations:

- `block h-2.5 overflow-hidden rounded-full bg-white/10`
- `block h-full rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500`
- `mb-2 flex items-center justify-between gap-3 text-sm`
- `min-w-0 truncate font-black text-slate-100`
- `mt-2 text-xs font-bold leading-5 text-slate-400`
...
- `shrink-0 rounded-full bg-white/10 px-2.5 py-1 font-mono text-xs font-black text-white`
- `space-y-3`
