...
Dashboard internal component implemented in src/components/admin/dashboard/pomodoro.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-042`.
- Location: `Dashboard Admin/src/components/admin/dashboard/pomodoro.tsx`:172.
- File range: lines 172–182.
...
```tsx
{ icon: Icon, label, value }: { icon: typeof TimerReset; label: string; value: string }
```

Exact local props contract when statically resolvable:

```tsx
{ icon: typeof TimerReset; label: string; value: string }
```
...
| Spacing | `gap-2`, `p-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-mono`, `text-muted`, `text-xl`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
