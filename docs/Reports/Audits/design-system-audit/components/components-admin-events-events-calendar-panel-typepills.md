...
- Component ID: `MWI-COMP-061`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:1190.
- File range: lines 1190–1205.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-067 | [PokemonCardGrid](../components/components-admin-events-events-calendar-panel-pokemoncardgrid.md) (MWI-COMP-067) | Renders/imports this component |
...
| Spacing | `gap-1`, `mt-1`, `px-2`, `py-0.5` |
| Sizing | `h-3.5`, `w-3.5` |
| Typography | `font-black`, `text-[10px]`, `text-cyan-50` |
| Radius | `rounded-full` |
...
| `w-3.5` | base | static occurrence |

Exact className combinations:

- `-`
- `h-3.5 w-3.5 object-contain`
- `inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/10 px-2 py-0.5 text-[10px] font-black text-cyan-50`
