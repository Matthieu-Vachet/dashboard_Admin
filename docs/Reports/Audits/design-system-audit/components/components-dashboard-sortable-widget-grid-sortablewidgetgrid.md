...
source: "src/components/dashboard/sortable-widget-grid.tsx"
lines: 3-6
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for SortableWidgetGrid. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-285`.
- Location: `Dashboard Admin/src/components/dashboard/sortable-widget-grid.tsx`:3.
- File range: lines 3–6.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-238.
