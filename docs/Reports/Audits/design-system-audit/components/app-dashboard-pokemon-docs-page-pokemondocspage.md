---
id: MWI-COMP-013
component: "PokemonDocsPage"
category: "Page"
status: exported
source: "src/app/(dashboard)/pokemon-docs/page.tsx"
lines: 20-29
figma_priority: 40
...
App Router page component for /pokemon-docs. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-013`.
- Location: `Dashboard Admin/src/app/(dashboard)/pokemon-docs/page.tsx`:20.
- File range: lines 20–29.
...
|---|---|---|
| @/components/admin/pokemon/pokemon-api-explorer | PokemonApiExplorer | internal |
| @/components/admin/pokemon/pokemon-api-status | PokemonApiStatus | internal |
| @/components/admin/pokemon/pokemon-docs-viewer | PokemonDocsViewer | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-191 | [PokemonApiExplorer](../components/components-admin-pokemon-pokemon-api-explorer-pokemonapiexplorer.md) (MWI-COMP-191) | JSX/import relation |
...
| MWI-COMP-199 | [PokemonDocsViewer](../components/components-admin-pokemon-pokemon-docs-viewer-pokemondocsviewer.md) (MWI-COMP-199) | JSX/import relation |
...
Unique HTML/React tags: `div`, `PokemonApiExplorer`, `PokemonApiStatus`, `PokemonDocsViewer`.
...
| Spacing | `p-0`, `px-3`, `px-4`, `px-5`, `space-y-4` |
| Sizing | `h-10`, `min-h-10`, `min-h-12`, `min-h-9`, `w-10` |
| Typography | `hover:text-foreground`, `text-amber-100`, `text-cyan-100`, `text-danger`, `text-emerald-100`, `text-foreground`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-white`, `text-xs` |
| Radius | Not found |
...
| Opacity | Not found |
| Background | `bg-brand-2/10`, `bg-brand-3/10`, `bg-brand/12`, `bg-danger/12`, `bg-danger/15`, `bg-transparent`, `bg-warning/12`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
| Animation | Not found |
