...
- Component ID: `MWI-COMP-163`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:301.
- File range: lines 301–311.
...
Unique HTML/React tags: `CandyAmount`, `img`, `span`.
...
|---|---|---|
| candy | Not found | See exact signature/contract below |
| candyIcon | Not found | See exact signature/contract below |
| stardust | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ candy, stardust, candyIcon }
```
...
- Text properties: `candy`, `candyIcon`, `stardust`.
...
| `gap-x-3` | base | static occurrence |
