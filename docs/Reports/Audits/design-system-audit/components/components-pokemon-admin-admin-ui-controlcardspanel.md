...
Compatibility re-export preserving the legacy import path for ControlCardsPanel. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-293`.
- Location: `Dashboard Admin/src/components/pokemon-admin/admin-ui.jsx`:3.
- File range: lines 3–3.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-138.
