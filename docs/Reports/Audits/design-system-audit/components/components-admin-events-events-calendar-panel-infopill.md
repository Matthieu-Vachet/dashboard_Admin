...
- Component ID: `MWI-COMP-065`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:1447.
- File range: lines 1447–1454.
...
| Spacing | `mt-1`, `p-3` |
| Sizing | Not found |
| Typography | `break-words`, `font-black`, `text-[10px]`, `text-slate-500`, `text-sm`, `text-white`, `tracking-[0.18em]`, `uppercase` |
| Radius | `rounded-2xl` |
...
- `block text-[10px] font-black uppercase tracking-[0.18em] text-slate-500`
- `mt-1 block break-words text-sm font-black text-white`
