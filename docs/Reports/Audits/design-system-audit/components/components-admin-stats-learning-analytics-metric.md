...
- Component ID: `MWI-COMP-249`.
- Location: `Dashboard Admin/src/components/admin/stats/learning-analytics.tsx`:176.
- File range: lines 176–209.
...
| lucide-react | CheckSquare2 | icons |
...
| Sizing | `h-11`, `w-11` |
| Typography | `font-black`, `text-3xl`, `text-brand`, `text-brand-2`, `text-brand-3`, `text-muted`, `text-warning`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
