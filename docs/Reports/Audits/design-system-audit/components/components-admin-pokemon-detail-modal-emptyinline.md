...
- Component ID: `MWI-COMP-161`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:284.
- File range: lines 284–290.
...
| Spacing | `p-4` |
| Sizing | Not found |
| Typography | `font-bold`, `text-slate-300`, `text-sm` |
| Radius | `rounded-2xl` |
...
- `rounded-2xl border border-dashed border-white/15 bg-white/[0.035] p-4 text-sm font-bold text-slate-300`
