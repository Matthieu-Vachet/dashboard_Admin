...
- Component ID: `MWI-COMP-160`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:260.
- File range: lines 260–282.
...
Unique HTML/React tags: `div`, `Section`, `span`, `strong`.
...
|---|---|---|
| names | names = {} | See exact signature/contract below |
...
| Spacing | `gap-2`, `gap-3`, `mt-1`, `p-1.5`, `p-3` |
| Sizing | `h-9`, `min-w-0`, `w-9` |
| Typography | `break-words`, `font-black`, `text-[10px]`, `text-cyan-100`, `text-lg`, `text-slate-500`, `text-white`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-2xl`, `rounded-xl` |
| Borders/strokes | `border`, `border-amber-200/16`, `border-amber-200/20`, `border-cyan-200/16`, `border-cyan-200/20`, `border-emerald-200/16`, `border-emerald-200/20`, `border-rose-200/20`, `border-violet-200/16`, `border-violet-200/20`, `border-white/10` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-amber-400/[0.075]`, `bg-amber-400/10`, `bg-cyan-400/[0.075]`, `bg-cyan-400/10`, `bg-emerald-400/[0.075]`, `bg-emerald-400/10`, `bg-rose-400/10`, `bg-violet-400/[0.075]`, `bg-violet-400/10`, `bg-white/[0.06]`, `from-amber-400/15`, `from-cyan-400/15`, `from-emerald-400/15`, `from-rose-400/15`, `from-violet-400/15` |
| Animation | Not found |
...
| `grid-cols-[2.2rem_minmax(0,1fr)]` | base | conditional or expression-derived |
...
- `grid grid-cols-[2.2rem_minmax(0,1fr)] gap-3 rounded-2xl border p-3`
- `grid h-9 w-9 place-items-center rounded-xl border border-white/10 bg-white/[0.06] p-1.5 text-xs font-black text-cyan-100`
- `min-w-0`
...
- `\`grid grid-cols-[2.2rem_minmax(0,1fr)] gap-3 rounded-2xl border p-3 ${cardTones[index % cardTones.length]}\``
