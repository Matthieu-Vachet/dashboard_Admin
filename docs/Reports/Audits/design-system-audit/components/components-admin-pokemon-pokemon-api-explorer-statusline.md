...
Pokémon internal component implemented in src/components/admin/pokemon/pokemon-api-explorer.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-192`.
- Location: `Dashboard Admin/src/components/admin/pokemon/pokemon-api-explorer.tsx`:133.
- File range: lines 133–133.
...
Unique HTML/React tags: `div`, `span`, `strong`.
...
| Spacing | `gap-1` |
| Sizing | Not found |
| Typography | `break-all`, `font-black`, `text-foreground`, `text-muted`, `text-sm`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | Not found |
...
- `break-all text-sm font-black text-foreground`
- `grid gap-1`
