...
- Component ID: `MWI-COMP-182`.
- Location: `Dashboard Admin/src/components/admin/pokemon/eggs-panel.jsx`:128.
- File range: lines 128–151.
...
|---|---|---|
| MWI-COMP-181 | [EggCard](../components/components-admin-pokemon-eggs-panel-eggcard.md) (MWI-COMP-181) | JSX/import relation |
...
Unique HTML/React tags: `div`, `EggCard`, `TierSection`.
...
```tsx
{ id, title, image, tone, pokemon, onOpenPokemon, typeCatalog = [] }
```
...
- Text properties: `id`, `image`, `onOpenPokemon`, `pokemon`, `title`, `tone`, `typeCatalog`.
...
- Responsive utilities: `2xl:grid-cols-4`, `sm:grid-cols-2`.
