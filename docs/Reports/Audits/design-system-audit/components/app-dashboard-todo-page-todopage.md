...
category: "Page"
status: exported
source: "src/app/(dashboard)/todo/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /todo. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-017`.
- Location: `Dashboard Admin/src/app/(dashboard)/todo/page.tsx`:3.
...
|---|---|---|
| @/components/admin/forms/todo-list | TodoList | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-087 | [TodoList](../components/components-admin-forms-todo-list-todolist.md) (MWI-COMP-087) | JSX/import relation |
...
Unique HTML/React tags: `TodoList`.
