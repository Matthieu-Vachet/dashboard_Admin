...
- Component ID: `MWI-COMP-040`.
- Location: `Dashboard Admin/src/components/admin/dashboard/dashboard-home-live.tsx`:651.
- File range: lines 651–657.
...
| MWI-COMP-037 | [KanbanBars](../components/components-admin-dashboard-dashboard-home-live-kanbanbars.md) (MWI-COMP-037) | Renders/imports this component |
...
| Spacing | `p-4` |
| Sizing | Not found |
| Typography | `font-semibold`, `text-muted`, `text-sm` |
| Radius | `rounded-lg` |
