...
- Component ID: `MWI-COMP-107`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:307.
- File range: lines 307–321.
...
Unique HTML/React tags: `div`, `h5`, `li`, `p`, `ul`.
...
| Spacing | `mt-3`, `pl-5`, `space-y-1`, `space-y-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-semibold`, `leading-6`, `text-foreground`, `text-muted`, `text-sm`, `whitespace-pre-wrap` |
| Radius | Not found |
...
| `list-disc` | base | static occurrence |
...
- `mt-3 space-y-3 text-sm font-semibold leading-6 text-muted`
- `whitespace-pre-wrap`
