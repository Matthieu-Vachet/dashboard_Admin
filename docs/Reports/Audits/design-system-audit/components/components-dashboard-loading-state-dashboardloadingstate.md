...
source: "src/components/dashboard/loading-state.tsx"
lines: 1-1
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for DashboardLoadingState. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-275`.
- Location: `Dashboard Admin/src/components/dashboard/loading-state.tsx`:1.
- File range: lines 1–1.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-237.
