...
- Component ID: `MWI-COMP-066`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:1456.
- File range: lines 1456–1474.
...
Unique HTML/React tags: `details`, `DetailSection`, `div`, `PokemonCardGrid`, `span`, `summary`.
...
|---|---|---|
| groups | Not found | See exact signature/contract below |
| onOpenPokemon | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ groups, onOpenPokemon }
```
...
- Text properties: `groups`, `onOpenPokemon`.
...
| Spacing | `gap-3`, `p-3`, `px-2`, `py-0.5`, `space-y-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-mono`, `text-[11px]`, `text-cyan-100`, `text-sm`, `text-white` |
| Radius | `rounded-full`, `rounded-xl` |
| Borders/strokes | `border`, `border-cyan-200/12` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-slate-950/32`, `bg-white/10` |
| Animation | Not found |
...
| `border-cyan-200/12` | base | static occurrence |
...
- `rounded-full bg-white/10 px-2 py-0.5 font-mono text-[11px] font-black text-cyan-100`
- `rounded-xl border border-cyan-200/12 bg-slate-950/32 p-3`
- `space-y-3`
