...
- Component ID: `MWI-COMP-049`.
- Location: `Dashboard Admin/src/components/admin/events/event-editor-modal.jsx`:107.
- File range: lines 107–114.
...
Unique HTML/React tags: `label`, `span`, `textarea`.
...
- Text properties: `label`, `onChange`, `value`.
...
| Spacing | `gap-1.5`, `px-4`, `py-3` |
| Sizing | `min-h-12`, `min-h-36`, `w-full` |
| Typography | `font-black`, `font-bold`, `leading-6`, `placeholder:text-slate-500`, `text-slate-500`, `text-sm`, `text-white`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-2xl` |
...
| `min-h-36` | base | conditional or expression-derived |
...
- `\`${fieldClass} min-h-36 py-3 leading-6\``
