...
- Component ID: `MWI-COMP-062`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:1242.
- File range: lines 1242–1257.
...
| Literal colors | `#22c55e`, `#22d3ee`, `#38bdf8`, `#64748b`, `#94a3b8`, `#a855f7`, `#ef4444`, `#f59e0b`, `rgba(2,6,23,.42)`, `rgba(255,255,255,0.09)` |
| Spacing | `gap-2`, `px-3`, `py-1` |
| Sizing | `min-h-9` |
| Typography | `font-black`, `text-[10px]`, `text-white`, `text-white/55`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-full` |
| Borders/strokes | `border` |
| Shadows/elevation | `shadow-[inset_0_1px_0_rgba(255,255,255,0.09)]` |
| Opacity | Not found |
...
| `shadow-[inset_0_1px_0_rgba(255,255,255,0.09)]` | base | static occurrence |
| `text-[10px]` | base | static occurrence |
| `text-white` | base | static occurrence |
| `text-white/55` | base | static occurrence |
...
- `inline-flex min-h-9 items-center gap-2 rounded-full border px-3 py-1 text-xs font-black text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.09)]`
...
- `{{ borderColor: hexToRgba(theme.color, 0.34), background: \`linear-gradient(135deg, ${hexToRgba(theme.color, 0.18)}, rgba(2,6,23,.42))\`, boxShadow: \`0 0 22px ${hexToRgba(theme.color, 0.10)}\`, }}`
