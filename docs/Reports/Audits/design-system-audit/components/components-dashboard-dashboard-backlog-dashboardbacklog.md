...
source: "src/components/dashboard/dashboard-backlog.tsx"
lines: 3-3
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for DashboardBacklog. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-266`.
- Location: `Dashboard Admin/src/components/dashboard/dashboard-backlog.tsx`:3.
- File range: lines 3–3.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-252.
