...
- Component ID: `MWI-COMP-323`.
- Location: `Dashboard Admin/src/components/ui/input.tsx`:4.
- File range: lines 4–18.
...
|---|---|---|
| react | forwardRef, InputHTMLAttributes | external package |
| @/lib/cn | cn | internal |
...
| MWI-COMP-258 | [Field](../components/components-admin-tables-dashboard-backlog-field.md) (MWI-COMP-258) | Renders/imports this component |
...
| Typography | `font-semibold`, `placeholder:text-muted/70`, `text-foreground`, `text-sm` |
| Radius | `rounded-lg` |
...
| `font-semibold` | base | conditional or expression-derived |
...
- `cn( "min-h-11 w-full rounded-lg border border-line bg-white/[0.06] px-3 text-sm font-semibold text-foreground outline-none transition placeholder:text-muted/70 focus:border-brand-2/55 focus:bg-white/[0.09]", className, )`
