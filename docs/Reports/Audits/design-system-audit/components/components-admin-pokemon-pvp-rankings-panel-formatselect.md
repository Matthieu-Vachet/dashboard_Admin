...
- Component ID: `MWI-COMP-205`.
- Location: `Dashboard Admin/src/components/admin/pokemon/pvp-rankings-panel.jsx`:111.
- File range: lines 111–114.
...
- <select aria-label="Ligue">
  - <optgroup>
    - <option>

Unique HTML/React tags: `optgroup`, `option`, `select`.
...
|---|---|---|
| formats | Not found | See exact signature/contract below |
...
- Text properties: `formats`, `onChange`, `value`.
...
| Typography | `font-bold`, `placeholder:text-slate-500`, `text-sm`, `text-white` |
| Radius | `rounded-2xl` |
...
- ARIA attributes: `aria-label="Ligue"`.
- Roles: Not found.
