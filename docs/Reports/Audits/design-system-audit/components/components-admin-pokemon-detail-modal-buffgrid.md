...
- Component ID: `MWI-COMP-165`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:410.
- File range: lines 410–429.
...
|---|---|---|
| buffs | Not found | See exact signature/contract below |
...
| Spacing | `gap-2`, `mt-1`, `mt-3`, `px-3`, `py-2` |
| Sizing | Not found |
| Typography | `font-black`, `text-[10px]`, `text-slate-500`, `text-white`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-xl` |
...
- Responsive utilities: `lg:grid-cols-5`, `sm:grid-cols-2`.
