...
- Component ID: `MWI-COMP-219`.
- Location: `Dashboard Admin/src/components/admin/pokemon/rocket-panel.jsx`:158.
- File range: lines 158–177.
...
- `grid h-8 w-8 place-items-center rounded-full border border-white/10 bg-slate-950/35 p-1.5`
- `grid h-8 w-8 place-items-center rounded-full border border-white/10 bg-white/10 text-[10px] font-black text-white`
...
- ARIA attributes: `aria-label="Types Pokémon"`.
- Roles: Not found.
