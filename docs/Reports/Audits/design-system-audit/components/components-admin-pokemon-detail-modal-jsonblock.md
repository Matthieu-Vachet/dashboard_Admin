...
- Component ID: `MWI-COMP-176`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:964.
- File range: lines 964–972.
...
| Spacing | `p-4` |
| Sizing | `max-h-[62dvh]` |
| Typography | `leading-6`, `sm:text-sm`, `text-cyan-50`, `text-xs` |
| Radius | `rounded-3xl` |
| Borders/strokes | `border`, `border-cyan-300/15` |
| Shadows/elevation | `shadow-inner` |
| Opacity | Not found |
...
| `max-h-[62dvh]` | base | static occurrence |
...
- `max-h-[62dvh] overflow-auto rounded-3xl border border-cyan-300/15 bg-slate-950 p-4 text-xs leading-6 text-cyan-50 shadow-inner sm:text-sm`
...
- Breakpoints used: `sm`.
- Responsive utilities: `sm:text-sm`.
