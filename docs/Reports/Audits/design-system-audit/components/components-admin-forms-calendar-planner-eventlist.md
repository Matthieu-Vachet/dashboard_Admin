...
- Component ID: `MWI-COMP-077`.
- Location: `Dashboard Admin/src/components/admin/forms/calendar-planner.tsx`:642.
- File range: lines 642–670.
...
Unique HTML/React tags: `Badge`, `Card`, `div`, `EventButton`, `p`.
...
| Spacing | `gap-3`, `mt-4`, `p-3`, `p-4`, `space-y-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-semibold`, `text-amber-100`, `text-brand-2`, `text-cyan-100`, `text-emerald-100`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-xs`, `tracking-[0.18em]`, `uppercase` |
| Radius | `rounded-lg` |
...
| Opacity | Not found |
| Background | `bg-brand`, `bg-brand-2`, `bg-brand-2/10`, `bg-brand-3`, `bg-brand-3/10`, `bg-brand/12`, `bg-danger`, `bg-danger/12`, `bg-warning`, `bg-warning/12`, `bg-white/[0.045]`, `bg-white/[0.06]` |
| Animation | Not found |
