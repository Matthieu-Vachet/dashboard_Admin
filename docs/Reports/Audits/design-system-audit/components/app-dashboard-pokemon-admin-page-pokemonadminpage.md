---
id: MWI-COMP-012
component: "PokemonAdminPage"
category: "Page"
status: exported
source: "src/app/(dashboard)/pokemon-admin/page.tsx"
lines: 7-9
figma_priority: 40
...
App Router page component for /pokemon-admin. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-012`.
- Location: `Dashboard Admin/src/app/(dashboard)/pokemon-admin/page.tsx`:7.
- File range: lines 7–9.
...
|---|---|---|
| @/components/admin/pokemon/pokemon-admin-studio | PokemonAdminStudio | internal |
...
Unique HTML/React tags: `PokemonAdminStudio`.
