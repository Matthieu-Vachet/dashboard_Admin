...
source: "src/components/pokemon-admin/collections-panel.jsx"
lines: 3-3
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for CollectionsPanel. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-303`.
- Location: `Dashboard Admin/src/components/pokemon-admin/collections-panel.jsx`:3.
- File range: lines 3–3.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-150.
