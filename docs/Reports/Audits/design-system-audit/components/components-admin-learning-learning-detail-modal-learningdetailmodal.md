...
Learning feature component implemented in src/components/admin/learning/learning-detail-modal.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-098`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:27.
- File range: lines 27–107.
...
|---|---|---|
| lucide-react | Code2, ExternalLink, Library, Rocket, ScrollText, Target, Trophy | icons |
| @/components/ui/badge | Badge | internal |
| @/components/ui/modal | Modal | internal |
| @/lib/learning/javascript | getTopicStats, isCompletedLearningStatus | internal |
| @/types/admin/learning | LearningProgressMutationResult, LearningProgressPatch, RuntimeLearningTopic | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-099 | [TheoryCard](../components/components-admin-learning-learning-detail-modal-theorycard.md) (MWI-COMP-099) | JSX/import relation |
| MWI-COMP-100 | [ExerciseCard](../components/components-admin-learning-learning-detail-modal-exercisecard.md) (MWI-COMP-100) | JSX/import relation |
| MWI-COMP-101 | [PseudocodeCard](../components/components-admin-learning-learning-detail-modal-pseudocodecard.md) (MWI-COMP-101) | JSX/import relation |
| MWI-COMP-102 | [ChallengeCard](../components/components-admin-learning-learning-detail-modal-challengecard.md) (MWI-COMP-102) | JSX/import relation |
| MWI-COMP-103 | [ProjectCard](../components/components-admin-learning-learning-detail-modal-projectcard.md) (MWI-COMP-103) | JSX/import relation |
| MWI-COMP-108 | [UnitSection](../components/components-admin-learning-learning-detail-modal-unitsection.md) (MWI-COMP-108) | JSX/import relation |
| MWI-COMP-114 | [Info](../components/components-admin-learning-learning-detail-modal-info.md) (MWI-COMP-114) | JSX/import relation |
...
Unresolved/external JSX tags: `Code2`, `ExternalLink`, `Library`, `Rocket`, `ScrollText`, `Target`, `Trophy`.
...
Unique HTML/React tags: `a`, `Badge`, `ChallengeCard`, `Code2`, `div`, `ExerciseCard`, `ExternalLink`, `h3`, `Info`, `Library`, `Modal`, `p`, `ProjectCard`, `PseudocodeCard`, `Rocket`, `ScrollText`, `section`, `span`, `Target`, `TheoryCard`, `Trophy`, `UnitSection`.

## 5. React structure and state management

- Hooks: Not found.
- Local state initializers: Not found.
- Event handlers exposed in JSX: `onClose`, `onNotify`, `onSetProgress`.
...
| onNotify | Not found | See exact signature/contract below |
...
|---|---|---|
| onNotify | error | Explicit string literal in props contract |
| onNotify | success | Explicit string literal in props contract |
| onNotify | warning | Explicit string literal in props contract |

- Boolean properties for Figma: Hover, Error, Warning, Success, Empty, Expanded.
- Text properties: `onClose`, `onNotify`, `onSetProgress`, `saving`, `topic`.
- Instance swaps: `Code2`, `ExternalLink`, `Library`, `Rocket`, `ScrollText`, `Target`, `Trophy`.
...
| Spacing | `gap-2`, `gap-3`, `gap-4`, `mt-1`, `mt-3`, `p-0`, `p-3`, `p-4`, `px-3`, `px-4`, `px-5`, `py-3`, `sm:p-5`, `space-y-5` |
| Sizing | `h-10`, `max-w-6xl`, `min-h-10`, `min-h-12`, `min-h-9`, `w-10` |
| Typography | `font-black`, `font-semibold`, `hover:text-foreground`, `text-amber-100`, `text-brand`, `text-brand-2`, `text-brand-3`, `text-cyan-100`, `text-danger`, `text-emerald-100`, `text-foreground`, `text-lg`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-warning`, `text-white`, `text-xs` |
| Radius | `rounded-lg` |
| Borders/strokes | `border`, `border-brand-2/20`, `border-brand-2/30`, `border-brand-3/25`, `border-brand-3/30`, `border-brand/30`, `border-danger/30`, `border-danger/35`, `border-line`, `border-transparent`, `border-warning/30`, `border-warning/35`, `border-white/10`, `hover:border-danger/50`, `hover:border-line-strong` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-black/15`, `bg-brand-2/[0.06]`, `bg-brand-2/10`, `bg-brand-3/[0.05]`, `bg-brand-3/10`, `bg-brand/10`, `bg-brand/12`, `bg-danger/10`, `bg-danger/12`, `bg-danger/15`, `bg-transparent`, `bg-warning/10`, `bg-warning/12`, `bg-white/[0.035]`, `bg-white/[0.045]`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-brand-2/15`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
...
- `flex items-center justify-between gap-3 rounded-lg border border-brand-2/20 bg-brand-2/[0.06] px-3 py-3 text-sm font-black text-brand-2 transition hover:bg-brand-2/15`
- `font-black`
- `grid gap-2 sm:grid-cols-2 lg:grid-cols-3`
- `grid gap-3 md:grid-cols-3`
- `grid gap-4 rounded-lg border border-line bg-white/[0.035] p-4 sm:p-5`
- `h-10 w-10 p-0`
- `max-w-6xl`
...
- `rounded-lg border border-brand-3/25 bg-brand-3/[0.05] p-4`
...
- Responsive utilities: `lg:grid-cols-3`, `md:grid-cols-3`, `sm:grid-cols-2`, `sm:p-5`.
...
- Lucide icons: `Code2`, `ExternalLink`, `Library`, `Rocket`, `ScrollText`, `Target`, `Trophy`.
...
- Boolean properties: Hover, Error, Warning, Success, Empty, Expanded.
- Instance swaps: `Code2`, `ExternalLink`, `Library`, `Rocket`, `ScrollText`, `Target`, `Trophy`.
...
| — | Sticky | Not found |
| □ | Variant: onNotify=error | Explicit props contract |
| □ | Variant: onNotify=success | Explicit props contract |
| □ | Variant: onNotify=warning | Explicit props contract |
