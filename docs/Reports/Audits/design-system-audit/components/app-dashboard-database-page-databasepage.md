...
category: "Page"
status: exported
source: "src/app/(dashboard)/database/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /database. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-004`.
- Location: `Dashboard Admin/src/app/(dashboard)/database/page.tsx`:3.
...
|---|---|---|
| @/components/admin/stats/database-stats | DatabaseStats | internal |
...
Unique HTML/React tags: `DatabaseStats`.
...
- Boolean properties for Figma: Hover, Error.
...
- Boolean properties: Hover, Error.
- Instance swaps: Not found.
