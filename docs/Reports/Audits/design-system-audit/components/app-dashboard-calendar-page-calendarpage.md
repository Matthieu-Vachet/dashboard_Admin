...
App Router page component for /calendar. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-003`.
- Location: `Dashboard Admin/src/app/(dashboard)/calendar/page.tsx`:3.
...
|---|---|---|
| @/components/admin/forms/calendar-planner | CalendarPlanner | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-073 | [CalendarPlanner](../components/components-admin-forms-calendar-planner-calendarplanner.md) (MWI-COMP-073) | JSX/import relation |
...
Unique HTML/React tags: `CalendarPlanner`.
...
| Opacity | Not found |
| Background | `bg-brand`, `bg-brand-2`, `bg-brand-2/10`, `bg-brand-3`, `bg-brand-3/10`, `bg-brand/12`, `bg-danger`, `bg-danger/12`, `bg-danger/15`, `bg-transparent`, `bg-warning`, `bg-warning/12`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
| Animation | Not found |
...
|---|---|---|
| `bg-brand` | base | static occurrence |
