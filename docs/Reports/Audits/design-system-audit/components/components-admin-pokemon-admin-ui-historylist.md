...
- Component ID: `MWI-COMP-136`.
- Location: `Dashboard Admin/src/components/admin/pokemon/admin-ui.jsx`:229.
- File range: lines 229–252.
...
| MWI-COMP-295 | [HistoryList](../components/components-pokemon-admin-admin-ui-historylist.md) (MWI-COMP-295) | Renders/imports this component |
...
Unique HTML/React tags: `div`, `p`, `small`, `span`, `strong`.
...
| Spacing | `mt-1`, `p-4`, `space-y-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-bold`, `font-mono`, `text-cyan-200/70`, `text-slate-400`, `text-slate-500`, `text-sm`, `text-white`, `text-xs`, `tracking-[0.18em]`, `uppercase` |
| Radius | `rounded-2xl` |
...
- `mt-1 block font-mono text-xs text-cyan-200/70`
