...
- Component ID: `MWI-COMP-021`.
- Location: `Dashboard Admin/src/app/layout.tsx`:15.
- File range: lines 15–28.
...
|---|---|---|
| sonner | Toaster | external package |
| ./globals.css | side effect | internal |
| @/components/admin/layout/admin-providers | Providers | internal |
...
Unresolved/external JSX tags: `Toaster`.
...
Unique HTML/React tags: `body`, `html`, `Providers`, `Toaster`.
...
- Boolean properties for Figma: Warning, Read Only.
...
- Boolean properties: Warning, Read Only.
- Instance swaps: Not found.
