...
- Component ID: `MWI-COMP-164`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:348.
- File range: lines 348–350.
...
|---|---|---|
| MWI-COMP-157 | [TypeBadge](../components/components-admin-pokemon-detail-modal-typebadge.md) (MWI-COMP-157) | JSX/import relation |
...
Unique HTML/React tags: `TypeBadge`.
...
| typeCatalog | Not found | See exact signature/contract below |
...
- Text properties: `type`, `typeCatalog`.
