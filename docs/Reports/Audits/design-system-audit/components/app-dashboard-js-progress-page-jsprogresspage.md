---
id: MWI-COMP-006
component: "JsProgressPage"
category: "Page"
status: exported
source: "src/app/(dashboard)/js-progress/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /js-progress. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-006`.
- Location: `Dashboard Admin/src/app/(dashboard)/js-progress/page.tsx`:3.
...
|---|---|---|
| @/components/admin/forms/js-progress | JsProgress | internal |
...
Unique HTML/React tags: `JsProgress`.
...
| Typography | `hover:text-foreground`, `text-amber-100`, `text-brand`, `text-brand-2`, `text-brand-3`, `text-cyan-100`, `text-danger`, `text-emerald-100`, `text-foreground`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-warning`, `text-white`, `text-xs` |
| Radius | Not found |
