...
- Component ID: `MWI-COMP-225`.
- Location: `Dashboard Admin/src/components/admin/pokemon/shiny-tracker-panel.jsx`:40.
- File range: lines 40–49.
...
|---|---|---|
| lucide-react | Sparkles, TrendingDown, TrendingUp | icons |
...
Unresolved/external JSX tags: `Sparkles`, `TrendingDown`, `TrendingUp`.
...
Unique HTML/React tags: `span`, `Sparkles`, `TrendingDown`, `TrendingUp`.
...
| variation | Not found | See exact signature/contract below |
...
- Boolean properties for Figma: Success.
- Text properties: `value`, `variation`.
- Instance swaps: `Sparkles`, `TrendingDown`, `TrendingUp`.
...
| Spacing | `gap-1` |
| Sizing | Not found |
| Typography | `font-black`, `font-mono`, `text-emerald-300`, `text-red-300`, `text-slate-400`, `text-xs` |
| Radius | Not found |
...
| `text-emerald-300` | base | conditional or expression-derived |
| `text-red-300` | base | conditional or expression-derived |
| `text-slate-400` | base | conditional or expression-derived |
| `text-xs` | base | conditional or expression-derived |

Exact className combinations:

- `inline-flex items-center gap-1 font-mono text-xs font-black`
- `text-emerald-300`
- `text-red-300`
- `text-slate-400`
...
- `\`inline-flex items-center gap-1 font-mono text-xs font-black ${positive ? "text-emerald-300" : negative ? "text-red-300" : "text-slate-400"}\``
...
- Lucide icons: `Sparkles`, `TrendingDown`, `TrendingUp`.
