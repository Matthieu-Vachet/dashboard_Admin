...
App Router page component for /analytics. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-002`.
- Location: `Dashboard Admin/src/app/(dashboard)/analytics/page.tsx`:3.
...
|---|---|---|
| @/components/admin/stats/learning-analytics | LearningAnalytics | internal |
...
Unique HTML/React tags: `LearningAnalytics`.
