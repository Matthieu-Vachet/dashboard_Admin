...
- Component ID: `MWI-COMP-053`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:874.
- File range: lines 874–919.
...
|---|---|---|
| MWI-COMP-054 | [CalendarDayCell](../components/components-admin-events-events-calendar-panel-calendardaycell.md) (MWI-COMP-054) | JSX/import relation |
| MWI-COMP-055 | [MultiDaySegment](../components/components-admin-events-events-calendar-panel-multidaysegment.md) (MWI-COMP-055) | JSX/import relation |
...
Unique HTML/React tags: `CalendarDayCell`, `div`, `MultiDaySegment`.

## 5. React structure and state management

- Hooks: Not found.
- Local state initializers: Not found.
- Event handlers exposed in JSX: `onCreate`, `onOpen`, `onOpenDay`.
...
| todayKey | Not found | See exact signature/contract below |
| week | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ week, cursor, events, todayKey, compact, onOpen, onCreate, onOpenDay }
```
...
- Text properties: `compact`, `cursor`, `events`, `onCreate`, `onOpen`, `onOpenDay`, `todayKey`, `week`.
...
| Spacing | `gap-x-1`, `inset-x-1`, `top-11` |
| Sizing | `min-w-0` |
...
| `gap-x-1` | base | static occurrence |
| `grid` | base | static occurrence |
| `grid-cols-7` | base | static occurrence |
| `inset-x-1` | base | static occurrence |
| `min-w-0` | base | static occurrence |
| `overflow-hidden` | base | static occurrence |
| `relative` | base | static occurrence |
| `rounded-2xl` | base | static occurrence |
| `top-11` | base | static occurrence |
| `z-20` | base | static occurrence |

Exact className combinations:

- `absolute inset-x-1 top-11 z-20 grid grid-cols-7 gap-x-1`
- `grid grid-cols-7`
- `relative min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-slate-950/25`
