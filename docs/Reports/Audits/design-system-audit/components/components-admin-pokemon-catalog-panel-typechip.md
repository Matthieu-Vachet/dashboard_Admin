...
- Component ID: `MWI-COMP-145`.
- Location: `Dashboard Admin/src/components/admin/pokemon/catalog-panel.jsx`:41.
- File range: lines 41–59.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-146 | [TypeCatalogCard](../components/components-admin-pokemon-catalog-panel-typecatalogcard.md) (MWI-COMP-146) | Renders/imports this component |
...
| multiplier | Not found | See exact signature/contract below |
| type | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ type, catalog = [], multiplier }
```
...
- Text properties: `catalog`, `multiplier`, `type`.
...
| Literal colors | `#0b6dc3`, `#5090d6`, `#5269ad`, `#5a5465`, `#5a8ea2`, `#63bc5a`, `#64748b`, `#73cec0`, `#89aae3`, `#919aa2`, `#91c12f`, `#aa6bc8`, `#c5b78c`, `#ce416b`, `#d97845`, `#ec8fe6`, `#f4d23c`, `#fa7179`, `#ff9d55`, `color-mix(in srgb, ${color} 38%, rgba(15,23,42,.72))`, `color-mix(in srgb, ${color} 45%, rgba(255,255,255,.16))` |
| Spacing | `gap-2`, `px-3`, `py-1` |
| Sizing | `h-4`, `min-h-8`, `w-4` |
...
- `inline-flex min-h-8 items-center gap-2 rounded-full border px-3 py-1 text-xs font-black text-white`
- `opacity-75`
...
- `{{ borderColor: \`color-mix(in srgb, ${color} 45%, rgba(255,255,255,.16))\`, background: \`color-mix(in srgb, ${color} 38%, rgba(15,23,42,.72))\`, }}`
