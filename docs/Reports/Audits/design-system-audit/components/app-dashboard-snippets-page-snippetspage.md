...
category: "Page"
status: exported
source: "src/app/(dashboard)/snippets/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /snippets. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-016`.
- Location: `Dashboard Admin/src/app/(dashboard)/snippets/page.tsx`:3.
...
|---|---|---|
| @/components/admin/dashboard/snippet-vault | SnippetVault | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-043 | [SnippetVault](../components/components-admin-dashboard-snippet-vault-snippetvault.md) (MWI-COMP-043) | JSX/import relation |
...
Unique HTML/React tags: `SnippetVault`.
...
| Radius | Not found |
| Borders/strokes | `border-amber-300/24`, `border-brand-2/30`, `border-brand-3/30`, `border-brand/30`, `border-cyan-300/24`, `border-danger/30`, `border-danger/35`, `border-emerald-300/24`, `border-line`, `border-rose-300/24`, `border-transparent`, `border-violet-300/24`, `border-warning/35`, `hover:border-danger/50`, `hover:border-line-strong` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-amber-400/8`, `bg-brand-2/10`, `bg-brand-3/10`, `bg-brand/12`, `bg-cyan-400/8`, `bg-danger/12`, `bg-danger/15`, `bg-emerald-400/8`, `bg-rose-400/8`, `bg-transparent`, `bg-violet-400/8`, `bg-warning/12`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
| Animation | Not found |
