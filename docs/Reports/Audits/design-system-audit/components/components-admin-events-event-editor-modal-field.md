...
- Component ID: `MWI-COMP-047`.
- Location: `Dashboard Admin/src/components/admin/events/event-editor-modal.jsx`:85.
- File range: lines 85–92.
...
| placeholder | placeholder = "" | See exact signature/contract below |
| type | type = "text" | See exact signature/contract below |
...
- Text properties: `label`, `onChange`, `placeholder`, `type`, `value`.
