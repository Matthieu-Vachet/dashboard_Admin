...
- Component ID: `MWI-COMP-170`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:642.
- File range: lines 642–680.
...
Unique HTML/React tags: `div`, `EmptyInline`, `img`, `PokemonMiniCard`, `Section`, `span`.
...
| candyIcon | Not found | See exact signature/contract below |
| evolutions | evolutions = [] | See exact signature/contract below |
| onOpenRelated | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ evolutions = [], allEntries = [], onOpenRelated, candyIcon }
```
...
- Text properties: `allEntries`, `candyIcon`, `evolutions`, `onOpenRelated`.
...
| Spacing | `gap-2`, `gap-3`, `px-3`, `py-1`, `space-y-2` |
| Sizing | `h-4`, `w-4` |
...
| Opacity | Not found |
| Background | `bg-amber-400/10`, `bg-cyan-400/10`, `bg-emerald-400/10`, `bg-rose-400/10`, `bg-slate-950/45`, `bg-violet-400/10`, `from-amber-400/15`, `from-cyan-400/15`, `from-emerald-400/15`, `from-rose-400/15`, `from-violet-400/15` |
| Animation | Not found |
...
- `inline-flex items-center gap-2 rounded-full border border-white/10 bg-slate-950/45 px-3 py-1 text-xs font-black text-white`
- `Item:`
- `rounded-full border border-white/10 bg-slate-950/45 px-3 py-1 text-xs font-black text-white`
- `space-y-2`
