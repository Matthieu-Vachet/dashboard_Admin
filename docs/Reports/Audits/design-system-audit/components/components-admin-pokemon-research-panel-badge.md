...
- Component ID: `MWI-COMP-212`.
- Location: `Dashboard Admin/src/components/admin/pokemon/research-panel.jsx`:140.
- File range: lines 140–146.
...
| MWI-COMP-214 | [ItemReward](../components/components-admin-pokemon-research-panel-itemreward.md) (MWI-COMP-214) | Renders/imports this component |
| MWI-COMP-216 | [ResearchTask](../components/components-admin-pokemon-research-panel-researchtask.md) (MWI-COMP-216) | Renders/imports this component |
...
| tone | tone = "border-white/10 bg-white/[0.07] text-white" | See exact signature/contract below |

Exact parameter signature:

```tsx
{ children, tone = "border-white/10 bg-white/[0.07] text-white" }
```
...
| Spacing | `gap-1`, `px-2.5`, `py-1` |
| Sizing | `min-h-7` |
| Typography | `font-black`, `text-[10px]`, `text-white`, `tracking-[0.1em]`, `uppercase` |
| Radius | `rounded-full` |
...
| `tracking-[0.1em]` | base | conditional or expression-derived |
| `uppercase` | base | conditional or expression-derived |

Exact className combinations:

- `border-white/10 bg-white/[0.07] text-white`
- `inline-flex min-h-7 items-center gap-1 rounded-full border px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.1em]`

## 12. Conditional classes, variables and inline styles

### Conditional class expressions

- `\`inline-flex min-h-7 items-center gap-1 rounded-full border px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.1em] ${tone}\``
