...
App Router page component for /tools. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-019`.
- Location: `Dashboard Admin/src/app/(dashboard)/tools/page.tsx`:3.
...
|---|---|---|
| @/components/admin/dashboard/daily-tools | DailyTools | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-028 | [DailyTools](../components/components-admin-dashboard-daily-tools-dailytools.md) (MWI-COMP-028) | JSX/import relation |
...
Unique HTML/React tags: `DailyTools`.
