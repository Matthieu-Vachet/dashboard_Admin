...
- Component ID: `MWI-COMP-109`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:343.
- File range: lines 343–345.
...
Unique HTML/React tags: `article`.
