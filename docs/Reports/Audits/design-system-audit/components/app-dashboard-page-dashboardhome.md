...
App Router page component for /. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-010`.
- Location: `Dashboard Admin/src/app/(dashboard)/page.tsx`:3.
...
|---|---|---|
| @/components/admin/dashboard/dashboard-home-live | DashboardHomeLive | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-030 | [DashboardHomeLive](../components/components-admin-dashboard-dashboard-home-live-dashboardhomelive.md) (MWI-COMP-030) | JSX/import relation |
...
Unique HTML/React tags: `DashboardHomeLive`.
