...
Compatibility re-export preserving the legacy import path for SourceHistoryModal. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-313`.
...
- Compatibility target: MWI-COMP-230.
