...
source: "src/components/dashboard/dashboard-footer.tsx"
lines: 1-1
figma_priority: 8
...
Compatibility re-export preserving the legacy import path for DashboardFooter. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-268`.
- Location: `Dashboard Admin/src/components/dashboard/dashboard-footer.tsx`:1.
- File range: lines 1–1.
- Definition kind: re-export.
- Export status: exported.
- Compatibility target: MWI-COMP-236.
