...
Pokémon feature component implemented in src/components/admin/pokemon/eggs-panel.jsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-183`.
- Location: `Dashboard Admin/src/components/admin/pokemon/eggs-panel.jsx`:153.
- File range: lines 153–250.
...
|---|---|---|
| lucide-react | Download, RefreshCcw, RotateCcw, Sparkles | icons |
...
| MWI-COMP-182 | [EggSection](../components/components-admin-pokemon-eggs-panel-eggsection.md) (MWI-COMP-182) | JSX/import relation |

Unresolved/external JSX tags: `Download`, `RefreshCcw`, `RotateCcw`, `Sparkles`.
...
| MWI-COMP-304 | [EggsPanel](../components/components-pokemon-admin-eggs-panel-eggspanel.md) (MWI-COMP-304) | Renders/imports this component |
...
Unique HTML/React tags: `AssetStatCard`, `button`, `DatasetFilterBar`, `DatasetSourceHeader`, `div`, `Download`, `EggSection`, `p`, `Panel`, `RefreshCcw`, `RotateCcw`, `Sparkles`.

## 5. React structure and state management

- Hooks: `useMemo`, `useState`.
- Local state initializers: `query = ""`, `rareOnly = false`, `shinyOnly = false`.
...
|---|---|---|
| eggs | Not found | See exact signature/contract below |
