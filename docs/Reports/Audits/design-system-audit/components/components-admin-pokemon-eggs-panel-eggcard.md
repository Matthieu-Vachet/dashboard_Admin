...
status: internal
source: "src/components/admin/pokemon/eggs-panel.jsx"
lines: 72-126
figma_priority: 18
...
Pokémon internal component implemented in src/components/admin/pokemon/eggs-panel.jsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-181`.
- Location: `Dashboard Admin/src/components/admin/pokemon/eggs-panel.jsx`:72.
- File range: lines 72–126.
...
| MWI-COMP-179 | [EggPill](../components/components-admin-pokemon-eggs-panel-eggpill.md) (MWI-COMP-179) | JSX/import relation |
| MWI-COMP-180 | [Rarity](../components/components-admin-pokemon-eggs-panel-rarity.md) (MWI-COMP-180) | JSX/import relation |
...
Unique HTML/React tags: `button`, `div`, `EggPill`, `h3`, `img`, `p`, `Rarity`, `small`, `span`, `Sparkles`, `TypeIcons`.
...
| Literal colors | `rgba(0,0,0,.2)`, `rgba(0,0,0,.38)`, `rgba(14,116,144,.58)`, `rgba(15,23,42,.88)`, `rgba(250,204,21,.2)`, `rgba(255,255,255,.1)`, `rgba(255,255,255,.12)` |
| Spacing | `gap-1`, `gap-1.5`, `gap-3`, `inset-0`, `left-3`, `mt-1`, `p-3`, `p-4`, `px-2.5`, `py-1`, `right-3`, `space-y-3`, `top-3` |
| Sizing | `max-h-28`, `min-h-[148px]`, `min-w-0` |
| Typography | `font-black`, `font-bold`, `text-[10px]`, `text-[11px]`, `text-amber-50`, `text-cyan-100/65`, `text-left`, `text-lg`, `text-red-50`, `text-slate-200`, `text-slate-400`, `text-slate-500`, `text-sm`, `text-white`, `text-xs`, `tracking-[0.12em]`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-2xl`, `rounded-full` |
| Borders/strokes | `border`, `border-amber-100/25`, `border-red-200/30`, `border-t`, `border-white/10`, `hover:border-cyan-200/35` |
| Shadows/elevation | `drop-shadow-[0_18px_34px_rgba(0,0,0,.38)]`, `shadow-[0_18px_70px_rgba(0,0,0,.2)]` |
| Opacity | `opacity-20` |
| Background | `bg-[radial-gradient(circle_at_50%_18%,rgba(250,204,21,.2),transparent_42%),linear-gradient(135deg,rgba(15,23,42,.88),rgba(14,116,144,.58))]`, `bg-amber-300/18`, `bg-red-400/16`, `bg-slate-950/38`, `bg-white/[0.055]` |
...
| `bg-[radial-gradient(circle_at_50%_18%,rgba(250,204,21,.2),transparent_42%),linear-gradient(135deg,rgba(15,23,42,.88),rgba(14,116,144,.58))]` | base | static occurrence |
...
- `relative grid min-h-[148px] place-items-center overflow-hidden bg-[radial-gradient(circle_at_50%_18%,rgba(250,204,21,.2),transparent_42%),linear-gradient(135deg,rgba(15,23,42,.88),rgba(14,116,144,.58))] p-4`
