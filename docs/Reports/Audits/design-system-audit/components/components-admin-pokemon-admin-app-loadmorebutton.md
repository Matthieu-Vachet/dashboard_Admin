...
- Component ID: `MWI-COMP-125`.
- Location: `Dashboard Admin/src/components/admin/pokemon/admin-app.jsx`:520.
- File range: lines 520–533.
...
Unique HTML/React tags: `button`, `div`.
...
| shown | Not found | See exact signature/contract below |
...
- Text properties: `onClick`, `shown`, `total`.
...
| Spacing | `mt-5`, `px-5`, `py-2` |
| Sizing | `min-h-11` |
| Typography | `font-black`, `text-cyan-50`, `text-sm` |
| Radius | `rounded-2xl` |
| Borders/strokes | `border`, `border-cyan-200/30`, `hover:border-cyan-200/55` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-cyan-400/12`, `hover:bg-cyan-400/20` |
