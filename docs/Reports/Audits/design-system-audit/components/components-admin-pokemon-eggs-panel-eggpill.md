...
- Component ID: `MWI-COMP-179`.
- Location: `Dashboard Admin/src/components/admin/pokemon/eggs-panel.jsx`:52.
- File range: lines 52–58.
...
| tone | tone = "" | See exact signature/contract below |
...
| Spacing | `px-2.5`, `py-1` |
| Sizing | `min-h-7` |
| Typography | `font-black`, `text-[11px]` |
| Radius | `rounded-full` |
...
- `inline-flex min-h-7 items-center rounded-full border px-2.5 py-1 text-[11px] font-black`

## 12. Conditional classes, variables and inline styles

### Conditional class expressions

- `\`inline-flex min-h-7 items-center rounded-full border px-2.5 py-1 text-[11px] font-black ${tone}\``
