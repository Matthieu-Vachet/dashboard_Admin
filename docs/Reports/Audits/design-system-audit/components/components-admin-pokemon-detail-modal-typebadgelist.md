...
- Component ID: `MWI-COMP-158`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:201.
- File range: lines 201–209.
...
Unique HTML/React tags: `span`, `TypeBadge`.
...
| types | types = [] | See exact signature/contract below |
...
- Text properties: `typeCatalog`, `types`.
