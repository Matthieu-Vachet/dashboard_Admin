...
Dashboard internal component implemented in src/components/admin/dashboard/daily-tools.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-029`.
- Location: `Dashboard Admin/src/components/admin/dashboard/daily-tools.tsx`:454.
- File range: lines 454–474.
...
Unique HTML/React tags: `div`, `h3`, `Icon`, `span`.
...
- Text properties: `action`, `Icon`, `title`.
...
| Spacing | `gap-3` |
| Sizing | `h-10`, `w-10` |
| Typography | `font-black`, `text-brand-2`, `text-lg` |
| Radius | `rounded-lg` |
