...
- Component ID: `MWI-COMP-050`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:234.
- File range: lines 234–239.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-059 | [TimelineCard](../components/components-admin-events-events-calendar-panel-timelinecard.md) (MWI-COMP-059) | Renders/imports this component |
...
Unique HTML/React tags: `img`.

## 5. React structure and state management

- Hooks: `useState`.
- Local state initializers: `failed = false`.
- Event handlers exposed in JSX: `onError`.
...
| src | Not found | See exact signature/contract below |
