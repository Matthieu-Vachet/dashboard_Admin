...
Internal component component implemented in src/components/admin/cards/pokemon-widget.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-024`.
- Location: `Dashboard Admin/src/components/admin/cards/pokemon-widget.tsx`:83.
- File range: lines 83–99.
...
Unique HTML/React tags: `div`, `Icon`, `p`.
...
| Spacing | `mt-1`, `mt-3`, `p-3` |
| Sizing | Not found |
| Typography | `font-black`, `font-mono`, `text-2xl`, `text-brand-2`, `text-muted`, `text-xs`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
...
- `mt-3 text-xs font-black uppercase tracking-[0.16em] text-muted`
