...
category: "Page"
status: exported
source: "src/app/(dashboard)/palette/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /palette. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-011`.
- Location: `Dashboard Admin/src/app/(dashboard)/palette/page.tsx`:3.
...
|---|---|---|
| @/components/admin/dashboard/color-lab | ColorLab | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-026 | [ColorLab](../components/components-admin-dashboard-color-lab-colorlab.md) (MWI-COMP-026) | JSX/import relation |
...
Unique HTML/React tags: `ColorLab`.
