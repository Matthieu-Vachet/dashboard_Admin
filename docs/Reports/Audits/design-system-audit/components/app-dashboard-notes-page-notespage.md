...
category: "Page"
status: exported
source: "src/app/(dashboard)/notes/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /notes. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-009`.
- Location: `Dashboard Admin/src/app/(dashboard)/notes/page.tsx`:3.
...
|---|---|---|
| @/components/admin/forms/notes-board | NotesBoard | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-086 | [NotesBoard](../components/components-admin-forms-notes-board-notesboard.md) (MWI-COMP-086) | JSX/import relation |
...
Unique HTML/React tags: `NotesBoard`.
...
| Typography | `hover:text-foreground`, `text-amber-100`, `text-brand-2`, `text-brand-3`, `text-cyan-100`, `text-danger`, `text-emerald-100`, `text-foreground`, `text-muted`, `text-rose-100`, `text-sm`, `text-violet-100`, `text-violet-200`, `text-warning`, `text-white`, `text-xs` |
| Radius | Not found |
| Borders/strokes | `border-brand-2/30`, `border-brand-2/40`, `border-brand-3/30`, `border-brand-3/40`, `border-brand/30`, `border-brand/40`, `border-danger/30`, `border-danger/35`, `border-danger/40`, `border-danger/45`, `border-line`, `border-transparent`, `border-warning/35`, `border-warning/40`, `border-warning/45`, `hover:border-danger/50`, `hover:border-line-strong` |
| Shadows/elevation | Not found |
| Opacity | Not found |
| Background | `bg-brand-2/10`, `bg-brand-2/12`, `bg-brand-3/10`, `bg-brand-3/12`, `bg-brand/12`, `bg-danger/12`, `bg-danger/15`, `bg-transparent`, `bg-warning/12`, `bg-white/[0.06]`, `bg-white/[0.075]`, `hover:bg-danger/20`, `hover:bg-white/[0.08]`, `hover:bg-white/[0.11]` |
| Animation | Not found |
