...
- Component ID: `MWI-COMP-114`.
- Location: `Dashboard Admin/src/components/admin/learning/learning-detail-modal.tsx`:370.
- File range: lines 370–372.
...
| Spacing | `mt-2`, `p-3` |
| Sizing | Not found |
| Typography | `font-black`, `leading-6`, `text-[11px]`, `text-muted`, `text-sm`, `tracking-[0.16em]`, `uppercase` |
| Radius | `rounded-lg` |
...
- `block text-[11px] font-black uppercase tracking-[0.16em] text-muted`
