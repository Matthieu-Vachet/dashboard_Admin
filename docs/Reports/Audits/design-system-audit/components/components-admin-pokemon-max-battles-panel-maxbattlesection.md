...
- Component ID: `MWI-COMP-188`.
- Location: `Dashboard Admin/src/components/admin/pokemon/max-battles-panel.jsx`:103.
- File range: lines 103–126.
...
|---|---|---|
| MWI-COMP-187 | [MaxBattleCard](../components/components-admin-pokemon-max-battles-panel-maxbattlecard.md) (MWI-COMP-187) | JSX/import relation |
...
- <TierSection id="max battle">
  - <div>
    - <MaxBattleCard />

Unique HTML/React tags: `div`, `MaxBattleCard`, `TierSection`.
...
```tsx
{ id, pokemon, onOpenPokemon, typeCatalog = [] }
```
