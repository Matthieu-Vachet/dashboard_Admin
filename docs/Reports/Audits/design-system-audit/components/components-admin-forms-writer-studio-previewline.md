...
- Component ID: `MWI-COMP-091`.
- Location: `Dashboard Admin/src/components/admin/forms/writer-studio.tsx`:301.
- File range: lines 301–324.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-090 | [DocumentPreview](../components/components-admin-forms-writer-studio-documentpreview.md) (MWI-COMP-090) | Renders/imports this component |
...
Unique HTML/React tags: `blockquote`, `div`, `h1`, `h2`, `p`.
...
|---|---|---|
| line | Not found | See exact signature/contract below |
...
| Spacing | `pl-4`, `px-4`, `py-3` |
| Sizing | `h-2` |
| Typography | `font-black`, `font-bold`, `font-semibold`, `leading-7`, `text-2xl`, `text-3xl`, `text-muted`, `text-sm` |
| Radius | Not found |
| Borders/strokes | `border-brand-2`, `border-l-4` |
...
| `border-brand-2` | base | static occurrence |
...
- `border-l-4 border-brand-2 bg-brand-2/10 px-4 py-3 text-sm font-bold text-muted`
- `h-2`
- `pl-4 text-sm font-semibold leading-7 text-muted`
- `text-2xl font-black`
- `text-3xl font-black`
- `text-sm font-semibold leading-7 text-muted`
