...
- Component ID: `MWI-COMP-162`.
- Location: `Dashboard Admin/src/components/admin/pokemon/detail-modal.jsx`:292.
- File range: lines 292–299.
...
| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-163 | [RewardValue](../components/components-admin-pokemon-detail-modal-rewardvalue.md) (MWI-COMP-163) | Renders/imports this component |
...
| label | label = "bonbons" | See exact signature/contract below |
| value | Not found | See exact signature/contract below |

Exact parameter signature:

```tsx
{ value, icon, label = "bonbons" }
```
...
|---|---|---|
| `align-middle` | base | static occurrence |
