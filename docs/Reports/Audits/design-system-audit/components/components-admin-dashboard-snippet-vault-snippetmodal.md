...
Dashboard internal component implemented in src/components/admin/dashboard/snippet-vault.tsx. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-044`.
- Location: `Dashboard Admin/src/components/admin/dashboard/snippet-vault.tsx`:174.
- File range: lines 174–213.
...
| @/data/personal-dashboard-defaults | Snippet | internal |
...
Unresolved/external JSX tags: `Check`.
...
Unique HTML/React tags: `Button`, `Check`, `div`, `Input`, `Modal`, `Textarea`.
...
| snippet | Not found | See exact signature/contract below |
...
- Boolean properties for Figma: Hover, Error, Empty, Expanded.
- Text properties: `onChange`, `onClose`, `onSave`, `snippet`.
- Instance swaps: `Check`.
...
| Spacing | `gap-3`, `p-0`, `px-3`, `px-4`, `px-5`, `space-y-4` |
| Sizing | `h-10`, `min-h-10`, `min-h-12`, `min-h-80`, `min-h-9`, `w-10`, `w-full` |
| Typography | `font-mono`, `hover:text-foreground`, `text-danger`, `text-foreground`, `text-muted`, `text-sm`, `text-white`, `text-xs` |
| Radius | Not found |
...
- `min-h-80 resize-y font-mono text-xs`
...
- Breakpoints used: `sm`.
- Responsive utilities: `sm:grid-cols-3`.
...
- Boolean properties: Hover, Error, Empty, Expanded.
- Instance swaps: `Check`.
