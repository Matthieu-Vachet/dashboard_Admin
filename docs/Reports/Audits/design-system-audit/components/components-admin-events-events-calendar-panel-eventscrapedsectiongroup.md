---
id: MWI-COMP-068
component: "EventScrapedSectionGroup"
...
- Component ID: `MWI-COMP-068`.
- Location: `Dashboard Admin/src/components/admin/events/events-calendar-panel.jsx`:1508.
- File range: lines 1508–1525.
...
| MWI-COMP-069 | [ScrapedSectionCard](../components/components-admin-events-events-calendar-panel-scrapedsectioncard.md) (MWI-COMP-069) | JSX/import relation |
...
Unique HTML/React tags: `DetailSection`, `div`, `ScrapedSectionCard`.
...
```tsx
{ title, tone, sections, onOpenPokemon }
```
...
- Text properties: `onOpenPokemon`, `sections`, `title`, `tone`.
