...
- Component ID: `MWI-COMP-196`.
- Location: `Dashboard Admin/src/components/admin/pokemon/pokemon-card.jsx`:49.
...
|---|---|---|
| @/components/site/pokemon-style | catalogItem | internal |
...
| weatherId | Not found | See exact signature/contract below |
...
- Text properties: `catalog`, `weatherId`.
...
| Spacing | `gap-2`, `px-3` |
| Sizing | `h-5`, `max-w-full`, `min-h-8`, `min-w-0`, `w-5` |
| Typography | `font-black`, `text-slate-100`, `text-xs` |
| Radius | `rounded-lg` |
...
- `inline-flex min-h-8 min-w-0 max-w-full items-center justify-center gap-2 overflow-hidden rounded-lg border border-white/10 bg-white/10 px-3 text-xs font-black text-slate-100`
- `truncate`
