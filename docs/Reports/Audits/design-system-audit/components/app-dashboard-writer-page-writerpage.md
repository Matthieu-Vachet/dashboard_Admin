...
category: "Page"
status: exported
source: "src/app/(dashboard)/writer/page.tsx"
lines: 3-5
figma_priority: 40
...
App Router page component for /writer. Product intent not directly expressed by implementation: Not found.

## 2. Description and usage

- Component ID: `MWI-COMP-020`.
- Location: `Dashboard Admin/src/app/(dashboard)/writer/page.tsx`:3.
...
|---|---|---|
| @/components/admin/forms/writer-studio | WriterStudio | internal |

### Child components

| ID | Component | Evidence |
|---|---|---|
| MWI-COMP-088 | [WriterStudio](../components/components-admin-forms-writer-studio-writerstudio.md) (MWI-COMP-088) | JSX/import relation |
...
Unique HTML/React tags: `WriterStudio`.
