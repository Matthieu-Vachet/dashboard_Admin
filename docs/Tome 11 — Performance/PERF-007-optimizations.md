...
# PERF-007 — Optimisations

## Autorité

Une optimisation doit conserver accessibilité, lisibilité, provenance et diagnostics. Elle est validée par mesure avant/après et par les tests fonctionnels.
...
`docs/Tome 10 — Tests/TEST-009-performance-tests.md`.
