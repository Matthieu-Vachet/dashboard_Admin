...
# PERF-002 — Mémoïsation

## Autorité

`useMemo` et `useCallback` sont réservés aux index, tris et callbacks stables mesurables ; ils ne servent pas à masquer un modèle de données instable.
...
`src/components/admin/pokemon/admin-app.jsx`, `src/components/admin/pokemon/pvp-battle-lab.tsx`.
