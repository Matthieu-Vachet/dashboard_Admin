...
- `identity-manager-providers` fournit la liste centrale utilisée par les filtres et la création d’alias ; elle inclut GO Hub et Margxt, tout en conservant « Autre… ».
