...
# TEST-002 — Tests unitaires

## Autorité

Les fonctions de normalisation, matching, calcul, statut et présentation doivent être testées sans réseau ni base réelle, avec cas positifs, absences et ambiguïtés.
...
`PokemonGo-Data/scripts/test-pokemon-identity-resolver.js`, `PokemonGo-API-/test/current-dataset-hash.test.js`.
