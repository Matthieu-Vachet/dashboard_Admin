...
# TEST-006 — Tests des providers

## Autorité

Chaque provider dispose de fixtures représentatives, timeouts, erreurs typées et diagnostics actionnables. Les protections externes ne sont jamais contournées.
...
`PokemonGo-Data/scripts/providers`, `PokemonGo-Data/scripts/test-defenders-costumes.js`.
