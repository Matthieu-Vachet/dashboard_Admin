...
# TEST-001 — Stratégie de tests

## Autorité

La pyramide combine validations statiques, tests unitaires, intégration API, tests navigateur et inspection visuelle. Un résultat critique en échec bloque publication et déploiement.
...
`package.json`, `scripts/validate-documentation.mjs`, `test`.
