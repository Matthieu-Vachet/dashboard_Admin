...
# TEST-005 — Tests responsive

## Autorité

Les largeurs obligatoires sont 320, 360, 375, 390, 414/430, 768, 1024 et 1440 px en Light et Dark, avec contrôle de débordement et zones sûres.
...
`scripts/test-pokemon-responsive.mjs`, `src/app/globals.css`.
