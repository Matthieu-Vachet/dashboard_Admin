...
export const adminRegenerationRegistry: readonly AdminRegenerationRegistration[] = Object.freeze([
  ...
  { id: "costume-audit", label: "Costumes / Event Pokémon", dashboardAction: "regenerate-costume-audit", apiPath: "/api/v1/admin/costume-audit/regenerate", generatorKey: "costume-audit", owner: "pokemon-api", kind: "generator", provider: "margxt", output: "operations/audits/costume/current.json + MongoDB", permission: "dashboard-admin", timeoutSeconds: 180, status: "active", global: true },
