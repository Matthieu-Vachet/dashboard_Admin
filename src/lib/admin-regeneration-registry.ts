...
export const adminRegenerationRegistry: readonly AdminRegenerationRegistration[] = Object.freeze([
  ...
  { id: "adventure-effects", label: "Synchroniser Adventure Effects", dashboardAction: "regenerate-adventure-effects", apiPath: "/api/v1/admin/adventure-effects/regenerate", generatorKey: "adventure-effects", owner: "pokemon-api", kind: "sync", provider: "Pokémon GO Hub + Margxt", output: "data/adventure-effects + rapport détaillé", permission: "dashboard-admin", timeoutSeconds: 180, status: "active", global: true },
  ...
  { id: "best-defenders", label: "Best Defenders", dashboardAction: "regenerate-best-defenders", apiPath: "/api/v1/admin/best-defenders/regenerate", generatorKey: "best-defenders", owner: "pokemon-api", kind: "generator", provider: "pokemon-go-hub-best-defenders", output: "data/rankings/pve/defenders.json + MongoDB", permission: "dashboard-admin", timeoutSeconds: 180, status: "active", global: true },
