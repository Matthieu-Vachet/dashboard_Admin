...
| `api/checklist-v3.js` | Nom historique de l'endpoint de bibliothèque API read-only : détails de fiche, catalogues et assets publics ; les anciennes actions internes exigent `x-api-admin-secret`. |
