...
function MoveBadge({ move, recommended, fastMove, selectedFastMove }) {
  ...
  return (
    <article className={`rounded-xl border border-line bg-surface-subtle p-3 ${move?.legacy ? "pvp-legacy-move" : ""}`} style={{ borderLeft: `4px solid ${typeColors[String(move?.type || "NORMAL").toUpperCase()] || typeColors.NORMAL}` }}>
