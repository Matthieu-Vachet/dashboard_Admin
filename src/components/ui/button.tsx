...
export function Button({
  ...
  const buttonClassName = cn(
    "type-control-strong inline-flex items-center justify-center gap-2 rounded-control border transition duration-motion-normal focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-2 disabled:cursor-not-allowed disabled:opacity-50",
    variants[variant],
    sizes[size],
    className,
  );
