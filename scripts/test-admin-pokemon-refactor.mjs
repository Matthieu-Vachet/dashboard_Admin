...
test("Veille expose une supervision filtrable, alignée et responsive", () => {
  ...
  assert.match(source, /Changement détecté/);
  assert.match(source, /Jamais vérifiée/);
  assert.match(source, /Tout acquitter/);
  assert.match(source, /source-watch-global-banner/);
