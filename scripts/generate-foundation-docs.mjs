...
const documents = [
  ...
  D("DOC-013", "Architecture des données", "Référence des référentiels statiques, datasets courants, données Dashboard et pipelines de transformation.",
    ...
    [["Datasets enregistrés", "DATASET-001 à DATASET-020"], ["Providers enregistrés", "PROVIDER-001 à PROVIDER-018"], ["Collections enregistrées", "COL-001 à COL-032"], ["Schémas Data", "schemas/pokemon/pokemon.schema.json et schemas/assets/pokemon-assets.schema.json"], ["Pipelines current API", "7 domaines"], ["Pipelines privés Dashboard", "Learning, Events, Source Watch et collection du dresseur"]],
  ...
  D("DOC-014", "Architecture des assets", "Référence des 17 familles d’assets, de leur stockage et de leurs consommateurs réels.",
    ["PokemonGo-Assets-API", "PokemonGo-Data/data/assets", "Dashboard Admin/public", "PokemonGo-API-/asset"],
    ...
    [["PokeMiners", "alimente", "ASSET-013"], ["PokemonGo-Assets-API", "alimente", "Dashboard, API, Landing et Data"], ["PokemonGo-Data/data/assets", "référence", "fichiers médias publiés"]],
