...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    ...
    "/api/json-builder": [
      ...
      "./runtime-data/PokemonGo-Data/data/moves/**/*",
      "./runtime-data/PokemonGo-Data/mappings/pokemon/identity-inventory.json",
      "./runtime-data/PokemonGo-Data/templates/**/*",
      "./runtime-data/PokemonGo-Data/schemas/**/*",
      "./runtime-data/PokemonGo-Data/tooling/lib/**/*",
      "./runtime-data/PokemonGo-Data/tooling/scripts/generators/generatePokemonLocalIdentityInventory.js",
    ],
